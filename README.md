...
```SQL
SELECT c.company_name AS Company, COUNT(*) AS OrderCount
...
```SQL
SELECT c.contact_name AS Company, COUNT(*) AS OrderCount
FROM orders o JOIN customers c
ON c.customer_id = o.customer_id
...
```SQL
SELECT c.city AS Company, COUNT(*) AS OrderCount
FROM orders o JOIN customers c
ON c.customer_id = o.customer_id
GROUP BY c.city
ORDER BY c.city
